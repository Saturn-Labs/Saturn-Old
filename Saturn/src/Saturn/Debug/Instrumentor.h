	...
	public:
		...
		void BeginSession(const std::string& name, const std::string& filepath = "results.json")
		{
			...
			if (m_CurrentSession)
			{
				...
				// profiling output.
				if (Saturn::Log::GetCoreLogger()) // Edge case: BeginSession() might be before Log::Init()
				{
...
#define ST_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Saturn::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
